...
func main() {
	...
	flag.IntVar(&fKeyMd, "md", int(geheim.DKeyMd), fmt.Sprintf("[encrypt] key message digest (%d:SHA3-224, %d:SHA3-256, %d:SHA3-384, %d:SHA3-512)", geheim.Sha3224, geheim.Sha3256, geheim.Sha3384, geheim.Sha3512))
